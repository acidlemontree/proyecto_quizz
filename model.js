...
exports.update = (id, question, answer) => {
    ...
    quizzes.splice(id, 1, {         //1 indica que solo se modificará 1 elemento del array
        question: (question || "").trim(),  //trim para quitar espacios
        answer: (answer || "").trim()
    });
    save();
};
 ...
 * @returns {any}
 */
exports.getAll = () => JSON.parse(JSON.stringify(quizzes)); //pasamos un copia de los datos del array
